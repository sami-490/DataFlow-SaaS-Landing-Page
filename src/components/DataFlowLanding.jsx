    ...
    <div style={{ background: '#f8fafc', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      ...
      <nav style={{
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div style={{ fontSize: '20px', fontWeight: '600', color: '#0f172a', display: 'flex', alignItems: 'center', gap: '8px' }}>
            <div style={{ width: '32px', height: '32px', background: 'linear-gradient(135deg, #06b6d4 0%, #0891b2 100%)', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontWeight: '700', fontSize: '14px' }}>
              DF
            </div>
            DataFlow
          </div>
      ...
      <section style={{ background: 'linear-gradient(135deg, #0f172a 0%, #1e293b 100%)', color: 'white', padding: '120px 24px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: '800px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
          <div style={{ display: 'inline-block', background: 'rgba(6, 182, 212, 0.1)', border: '1px solid rgba(6, 182, 212, 0.3)', padding: '8px 16px', borderRadius: '20px', marginBottom: '24px', fontSize: '13px', color: '#06b6d4' }}>
          ...
          {/* Flow Animation */}
          <div style={{ background: 'rgba(6, 182, 212, 0.05)', border: '1px solid rgba(6, 182, 212, 0.2)', borderRadius: '12px', padding: '32px', marginBottom: '48px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
              {['Source', 'Transform', 'Validate', 'Load'].map((label, i) => (
                <div key={i} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                  <div style={{ width: '48px', height: '48px', background: 'rgba(6, 182, 212, 0.2)', border: '2px solid #06b6d4', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '20px' }}>
                    {i === 0 && '📊'}
                    {i === 1 && '⚙️'}
                    {i === 2 && '✓'}
                    {i === 3 && '💾'}
          ...
          <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap' }}>
            <button style={{ padding: '14px 32px', background: '#06b6d4', color: '#0f172a', border: 'none', borderRadius: '8px', fontSize: '16px', fontWeight: '600', cursor: 'pointer', transition: 'all 0.2s', '&:hover': { opacity: 0.9 } }}>
              Start Free Trial
            </button>
            <button style={{ padding: '14px 32px', background: 'transparent', color: '#06b6d4', border: '2px solid #06b6d4', borderRadius: '8px', fontSize: '16px', fontWeight: '600', cursor: 'pointer', transition: 'all 0.2s' }}>
              Watch Demo
            </button>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '40px' }}>
            {[
              ...
              <div key={i} style={{ textAlign: 'center' }}>
                <div style={{ width: '60px', height: '60px', background: '#06b6d4', color: 'white', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '28px', fontWeight: '700', margin: '0 auto 20px' }}>
                  {step.num}
                </div>
          ...
          <div style={{ textAlign: 'center', marginBottom: '80px' }}>
            ...
            <div style={{ display: 'flex', gap: '16px', justifyContent: 'center' }}>
              <button
                ...
                style={{ padding: '10px 24px', background: activeTab === 'monthly' ? '#06b6d4' : 'transparent', color: activeTab === 'monthly' ? 'white' : '#64748b', border: activeTab === 'monthly' ? 'none' : '1px solid #e2e8f0', borderRadius: '6px', cursor: 'pointer', fontWeight: '500' }}
              >
                Monthly
              </button>
              <button
                onClick={() => setPricingTab('annual')}
                style={{ padding: '10px 24px', background: activeTab === 'annual' ? '#06b6d4' : 'transparent', color: activeTab === 'annual' ? 'white' : '#64748b', border: activeTab === 'annual' ? 'none' : '1px solid #e2e8f0', borderRadius: '6px', cursor: 'pointer', fontWeight: '500' }}
              >
                Annual (Save 20%)
              </button>
            </div>
